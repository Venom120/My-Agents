...
- `@/.opencode/agent-files/optimizer/REPORT.md` — your handoff report; write it each stage using the standard report structure (see Report Handoff)
...
- `@/.opencode/agent-files/optimizer/REPORT.md` (your own handoff report)
...
- **Before starting:** Read `@/.opencode/agent-files/implementer/REPORT.md`.
- **When finished:** Write `@/.opencode/agent-files/optimizer/REPORT.md` using the standard report structure (Task, Status, Context, Previous Agent, Findings, Decisions, Changes Made, Validation, Outstanding Issues, Recommendations, Next Agent).
